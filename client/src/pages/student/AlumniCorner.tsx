...
const AlumniCorner: React.FC = () => {
  ...
  const fetchAlumni = async () => {
    try {
      ...
      const res = await fetch(`${API_URL}/api/alumni?${params.toString()}`);
    ...
    const fetchRequests = async () => {
        try {
            const res = await fetch(`${API_URL}/api/alumni/mentorship/requests?type=sent`, {
                headers: {
    ...
    const sendRequest = async () => {
        ...
        try {
            const res = await fetch(`${API_URL}/api/alumni/mentorship/requests`, {
                method: 'POST',
                headers: {
